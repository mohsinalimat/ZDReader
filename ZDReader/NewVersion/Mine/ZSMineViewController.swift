...
class ZSMineViewController: BaseViewController, ZSMineNavigationBarDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationBar.loginState(state: .login, title: "", icon: "")
    ...
    private func setupMenu() {
        ...
        let level = ZSMineMenuItem(type: .level, disclosureType: .controllerWithTitle,cellType: .textIndicator, isSwitchOn: false, title: "经验等级", icon: "personal_icon_level _24_24_24x24_", detailTitle: nil, disclosureText: "\(0)级")
